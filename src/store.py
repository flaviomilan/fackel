...
from src.models import CVE, DomainReport, Evidence, Host, Person, Service


class StructuredStore:
    """Armazena resultados estruturados para correlação e scoring."""
    ...
    def add_service(
        ...
        # Deduplica pelo par protocolo/porta
    ...
    def add_person(
        self, name: str, role: Optional[str] = None, profile_url: Optional[str] = None, technologies: Optional[List[str]] = None
    ) -> None:
