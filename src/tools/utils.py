...
Utilities here are infrastructure-level: subprocess execution, target
normalisation, output envelope, binary/env-var guards, and JSONL parsing.
"""
...
from fackel.utils.network import is_valid_ip  # noqa: F401 — re-exported
...
# ── Lazy import for DuckDuckGo search SDK ──────────────────────────────
