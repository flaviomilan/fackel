...
def _subdomain_collector(base_domain: str) -> tuple[list[str], Callable[[object], None]]:
    ...
    Filters out reverse-PTR-style entries and the base domain itself.
    """
    subs: list[str] = []
