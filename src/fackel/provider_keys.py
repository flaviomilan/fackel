...
PROVIDER_KEYS: tuple[ProviderKeySpec, ...] = (
    ...
    ProviderKeySpec("Chaos", ("CHAOS_API_KEY",), ("chaos_enum",)),
    ProviderKeySpec("GreyNoise", ("GREYNOISE_API_KEY",), ("greynoise_lookup",)),
    ProviderKeySpec("AbuseIPDB", ("ABUSEIPDB_API_KEY",), ("abuseipdb_lookup",)),
    ProviderKeySpec("LeakCheck", ("LEAKCHECK_API_KEY",), ("breach_lookup",)),
    ProviderKeySpec("Netlas", ("NETLAS_API_KEY",), ("netlas_lookup",)),
