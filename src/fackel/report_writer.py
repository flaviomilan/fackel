...
def build_full_report(state: dict[str, Any]) -> str:  # noqa: C901 - sequential multi-section archival report builder
    ...
    if asset_inventory.strip():
        section_idx += 1
        sections.append("---\n")
        sections.append(f"## {section_idx}. " + asset_inventory.strip().removeprefix("## "))
        sections.append("")
