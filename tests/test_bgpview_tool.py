...
class TestBgpLookupHappyPath:
    ...
    @patch("tools.recon.bgpview_tool.requests.get")
    def test_multiple_asns_picks_first(self, mock_get: MagicMock) -> None:
    ...
    @patch("tools.recon.bgpview_tool.requests.get")
    def test_no_asns(self, mock_get: MagicMock) -> None:
    ...
    @patch("tools.recon.bgpview_tool.requests.get")
    def test_holder_without_separator(self, mock_get: MagicMock) -> None:
        mock_get.return_value = _ok_response(
            {
                "data": {
