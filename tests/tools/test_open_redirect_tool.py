...
class TestOpenRedirectScan:
    ...
    @patch("fackel.tools.vuln.open_redirect_tool.run_command")
    @patch("fackel.tools.vuln.open_redirect_tool.require_binary", return_value=None)
    ...
    @patch(
        "fackel.tools.vuln.open_redirect_tool.run_command",
