...
class TestLinkFinderExtract:
    ...
    @patch("tools.recon.linkfinder_tool.run_command")
    @patch("tools.recon.linkfinder_tool.require_binary", return_value=None)
    ...
    @patch("tools.recon.linkfinder_tool.run_command", side_effect=Exception("timeout"))
    @patch("tools.recon.linkfinder_tool.require_binary", return_value=None)
