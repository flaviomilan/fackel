...
class TestWhatWebScan:
    ...
    @patch("fackel.tools.recon.whatweb_tool.run_command")
    @patch("fackel.tools.recon.whatweb_tool.require_binary", return_value=None)
    ...
    @patch("fackel.tools.recon.whatweb_tool.run_command", side_effect=Exception("timeout"))
    @patch("fackel.tools.recon.whatweb_tool.require_binary", return_value=None)
