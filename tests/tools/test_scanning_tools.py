...
from fackel.tools.scanning.feroxbuster_tool import _find_wordlist, feroxbuster_scan
...
class TestFeroxbusterScan:
    ...
    @patch(
        "fackel.tools.scanning.feroxbuster_tool._find_wordlist", return_value="/mock/wordlist.txt"
    )
    ...
    @patch("fackel.tools.scanning.feroxbuster_tool._find_wordlist", return_value="")
    @patch("fackel.tools.scanning.feroxbuster_tool.require_binary", return_value=None)
...
class TestKatanaCrawl:
    ...
    @patch("fackel.tools.scanning.katana_tool.run_command")
    @patch("fackel.tools.scanning.katana_tool.require_binary", return_value=None)
...
class TestNaabuScan:
    ...
    @patch("fackel.tools.scanning.naabu_tool.run_command")
    @patch("fackel.tools.scanning.naabu_tool.require_binary", return_value=None)
...
class TestWafw00fDetect:
    ...
    @patch("fackel.tools.scanning.wafw00f_tool.run_command")
    @patch("fackel.tools.scanning.wafw00f_tool.require_binary", return_value=None)
    def test_adds_scheme_when_missing(self, _bin, mock_run):
