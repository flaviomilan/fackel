...
class TestS3ScannerScan:
    ...
    @patch("tools.scanning.s3scanner_tool.run_command")
    @patch("tools.scanning.s3scanner_tool.require_binary", return_value=None)
    ...
    @patch("tools.scanning.s3scanner_tool.run_command", side_effect=Exception("timeout"))
    @patch("tools.scanning.s3scanner_tool.require_binary", return_value=None)
