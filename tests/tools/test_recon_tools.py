...
class TestDnsResolve:
    ...
    @patch("fackel.tools.recon.dns_resolver.socket.getaddrinfo")
    ...
    @patch(
        "fackel.tools.recon.dns_resolver.socket.getaddrinfo", side_effect=socket.gaierror("no host")
    )
...
class TestCrtShSubdomainEnum:
    ...
    @patch("fackel.tools.recon.crtsh_tool.circuit_breaker")
    @patch("fackel.tools.recon.crtsh_tool.get_session")
    ...
    @patch("fackel.tools.recon.crtsh_tool.circuit_breaker")
    @patch("fackel.tools.recon.crtsh_tool._fetch_crtsh")
...
class TestReverseDnsLookup:
    ...
    @patch("fackel.tools.recon.reverse_dns_tool.get_session")
    @patch("fackel.tools.recon.reverse_dns_tool.socket.gethostbyaddr")
    ...
    @patch("fackel.tools.recon.reverse_dns_tool.get_session")
    @patch("fackel.tools.recon.reverse_dns_tool.socket.gethostbyaddr", side_effect=socket.herror())
...
class TestSubfinderEnum:
    ...
    @patch("fackel.tools.recon.subfinder_tool.run_command")
    @patch("fackel.tools.recon.subfinder_tool.require_binary", return_value=None)
    ...
    @patch("fackel.tools.recon.subfinder_tool.run_command", side_effect=Exception("timeout"))
    @patch("fackel.tools.recon.subfinder_tool.require_binary", return_value=None)
