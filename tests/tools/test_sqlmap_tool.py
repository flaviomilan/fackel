...
from fackel.tools.vuln.sqlmap_tool import _parse_sqlmap_text, sqlmap_scan


class TestSqlmapScan:
    """Verify SQLMap CLI construction and result parsing."""

    @patch("fackel.tools.vuln.sqlmap_tool.run_command")
    @patch("fackel.tools.vuln.sqlmap_tool.require_binary", return_value=None)
    ...
    @patch(
        "fackel.tools.vuln.sqlmap_tool.run_command",
