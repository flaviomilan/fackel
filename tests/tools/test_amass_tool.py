...
class TestAmassEnum:
    ...
    @patch("fackel.tools.recon.amass_tool.run_command")
    @patch("fackel.tools.recon.amass_tool.require_binary", return_value=None)
    ...
    @patch("fackel.tools.recon.amass_tool.run_command", side_effect=Exception("timeout"))
    @patch("fackel.tools.recon.amass_tool.require_binary", return_value=None)
    ...
    def test_rejects_url_target(self):
        ...
        with (
            patch("fackel.tools.recon.amass_tool.require_binary"),
            patch("fackel.tools.recon.amass_tool.run_command") as mock_run,
        ):
            mock_run.return_value = (0, "", "")
